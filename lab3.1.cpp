...
that hold the temperature value and make conversion functions in each class for conversion 
rom one to another. For example, you need to have a function toFahrenheit() in class Celsius
